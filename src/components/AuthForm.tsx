...
const AuthForm = () => {
  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      console.log('Google auth response:', { error });
      
      if (error) {
        console.error('Google sign in error:', error);
        toast({
          title: "Google Sign In Error",
          description: "Google authentication is not configured. Please use email/password or contact support.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "Google sign in is not available. Please use email/password instead.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  const handleGitHubSignIn = async () => {
    try {
      ...
      console.log('GitHub auth response:', { error });
      
      if (error) {
        console.error('GitHub sign in error:', error);
        toast({
          title: "GitHub Sign In Error",
          description: "GitHub authentication is not configured. Please use email/password or contact support.",
          variant: "destructive",
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Error",
        description: "GitHub sign in is not available. Please use email/password instead.",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <Button
              ...
              disabled={loading}
              variant="outline"
              className="w-full bg-white/50 hover:bg-gray-50 border-gray-200"
            >
